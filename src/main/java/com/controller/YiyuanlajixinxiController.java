...
public class YiyuanlajixinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,YiyuanlajixinxiEntity yiyuanlajixinxi, 
		...
		if(tableName.equals("yonghu")) {
			yiyuanlajixinxi.setYonghuming((String)request.getSession().getAttribute("username"));
		}
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,YiyuanlajixinxiEntity yiyuanlajixinxi, 
		HttpServletRequest request){
        EntityWrapper<YiyuanlajixinxiEntity> ew = new EntityWrapper<YiyuanlajixinxiEntity>();
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = yiyuanlajixinxiService.selectValue(params, ew);
    ...
    public R valueDay(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName, @PathVariable("timeStatType") String timeStatType,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = yiyuanlajixinxiService.selectTimeStatValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R group(@PathVariable("columnName") String columnName,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = yiyuanlajixinxiService.selectGroup(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
