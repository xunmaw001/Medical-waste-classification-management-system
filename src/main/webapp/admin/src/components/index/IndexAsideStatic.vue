<template>
	<div class="menu-preview">
		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"border":0,"padding":"0","listStyle":"none","margin":"15px 5px 0px 5px","position":"relative","background":"none"}' class="el-menu-vertical-demo" default-active="0">
	...
	methods: {
		...
		styleChange() {
			this.$nextTick(() => {
				  ...
				  const icon = {"border":"none","margin":"0 10px 10px 10px","borderRadius":"3px","background":"url(http://codegen.caihongy.cn/20221014/5e767dc0afa649ec9fbc71f9da086ab3.jpg)","display":"none"}
	...
	.menu-preview {
	  .el-scrollbar {
		...
		.el-menu-vertical-demo>.el-menu-item {
				  				  ...
				  				  color: #ddd;
				  				  white-space: nowrap;
				  				  background: url(http://codegen.caihongy.cn/20221014/c3b838d0141840deb69252825184ad4a.png) no-repeat;
				  				  line-height: 44px;
				  				  position: relative;
				  		}
		...
		// 				// 		background: url(http://codegen.caihongy.cn/20221014/5e767dc0afa649ec9fbc71f9da086ab3.jpg);
		// 				// 		display: none;
		// 				// }
