<template>
	<div class="addEdit-block" :style='{"padding":"30px"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.fankuitupian" label="反馈图片" prop="fankuitupian">
					<file-upload
						tip="点击上传反馈图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.fankuitupian" label="反馈图片" prop="fankuitupian">
					<img v-if="ruleForm.fankuitupian.substring(0,4)=='http'" class="upload-img" style="margin-right:20px;" v-bind:key="index" :src="ruleForm.fankuitupian.split(',')[0]" width="100" height="100">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.fankuineirong" label="反馈内容" prop="fankuineirong">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#00a9aa","fontWeight":"500","display":"inline-block"}'>{{ruleForm.fankuineirong}}</span>
				</el-form-item>
