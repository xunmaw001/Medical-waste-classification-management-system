	...
	<div class="addEdit-block" :style='{"padding":"30px"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="公告类型" prop="gonggaoleixing">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="公告类型" prop="gonggaoleixing">
					<el-input v-model="ruleForm.gonggaoleixing"
						placeholder="公告类型" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.gonggaotupian" label="公告图片" prop="gonggaotupian">
					<file-upload
						tip="点击上传公告图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.gonggaotupian" label="公告图片" prop="gonggaotupian">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.gonggaoneirong = this.ruleForm.gonggaoneirong.replace(reg,'../../../ssmwlz6j/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
